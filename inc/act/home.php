...
<div class="col3">
    ...
    '.($latest_map != null ? '
		<a href="'.$entry_point_sm.'?map='.$latest_map['id'].'">
			<img src="/t/'.$latest_map['id'].'" alt="'.$latest_map['title'].'" class="map_thumb_big" />
		</a><br />
    ...
    '.($map_of_the_week != null ? '
		<a href="'.$entry_point_sm.'?map='.$map_of_the_week['id'].'">
			<img src="/t/'.$map_of_the_week['id'].'" alt="'.$map_of_the_week['title'].'" class="map_thumb_big" />
		</a><br />
    ...
    '.($random_map != null ? '
		<a href="'.$entry_point_sm.'?map='.$random_map['id'].'">
			<img src="/t/'.$random_map['id'].'" alt="'.$random_map['title'].'" class="map_thumb_big" />
		</a><br />
